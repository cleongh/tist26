...
from ..domain import RuleLayer, StoryContext, Conflict
...
class ConflictResolver:
    ...
    def _generate_override_rule(self, conflict: Conflict) -> str:
        ...
        return asp_converter.story_override_rule_to_asp(
            violation_type=vtype,
            rule_id=conflict.universal_rule_id,
    ...
    def _generate_exception_rule(self, conflict: Conflict) -> str:
        ...
        asp_converter = _get_asp_converter()
        return asp_converter.story_exception_rule_to_asp(
            violation_type=conflict.violation_type,
